...
WallObject::WallObject(const Texture& RenTexture, Vector2f RenOffset, Vector2f Position, float Size) 
	...
	float innerRad = Size * Engine::GetGlobalConsts().GameObjs_OneSizeSpriteResolution*0.5;
...
Vector2f WallObject::GetResolvingPnt(const ColliderShape& objShape, Vector2f movDir) const {
